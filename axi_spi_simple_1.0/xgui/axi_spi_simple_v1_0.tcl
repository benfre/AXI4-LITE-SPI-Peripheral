...
proc update_PARAM_VALUE.SAXI_ADDR_WIDTH { PARAM_VALUE.SAXI_ADDR_WIDTH } {
	# Procedure called to update SAXI_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SAXI_ADDR_WIDTH { PARAM_VALUE.SAXI_ADDR_WIDTH } {
	# Procedure called to validate SAXI_ADDR_WIDTH
	return true
}

proc update_PARAM_VALUE.SAXI_DATA_WIDTH { PARAM_VALUE.SAXI_DATA_WIDTH } {
	# Procedure called to update SAXI_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SAXI_DATA_WIDTH { PARAM_VALUE.SAXI_DATA_WIDTH } {
	# Procedure called to validate SAXI_DATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.SAXI_DATA_WIDTH { MODELPARAM_VALUE.SAXI_DATA_WIDTH PARAM_VALUE.SAXI_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SAXI_DATA_WIDTH}] ${MODELPARAM_VALUE.SAXI_DATA_WIDTH}
}

proc update_MODELPARAM_VALUE.SAXI_ADDR_WIDTH { MODELPARAM_VALUE.SAXI_ADDR_WIDTH PARAM_VALUE.SAXI_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SAXI_ADDR_WIDTH}] ${MODELPARAM_VALUE.SAXI_ADDR_WIDTH}
}
